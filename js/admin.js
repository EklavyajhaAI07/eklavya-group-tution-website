...
const USE_SERVER = window.location.protocol !== 'file:'; // Use server API when hosted
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  console.log(USE_SERVER ? '📡 Using server storage' : '💾 Using local storage');
});
